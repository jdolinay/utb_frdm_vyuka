...
/* Konfigurace pro SPI driver */
// SPI0 [Driver_SPI0]
// Configuration settings for Driver_SPI0
//
#define   RTE_SPI0                      1

// SPI0_MISO Pin
#define		RTE_SPI0_MISO_PIN	(GPIO_C7)	/* PTA17/2; PTC7/2; PTD3/2 */
#define		RTE_SPI0_MISO_FUNC	(2)

// SPI0_MOSI Pin
#define		RTE_SPI0_MOSI_PIN	(GPIO_C6)	/* PTA16/2; PTC6/2; PTD2/2 */
...
// SPI0 [Driver_SPI1]
// Configuration settings for Driver_SPI1
//
#define   RTE_SPI1                      0

// Include file for SPI driver if needed
