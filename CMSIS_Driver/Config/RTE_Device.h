...
/* jd: zkopirovana konfigurace pro I2C */
/* puvodni MCU asi ma I2C0 s pevne danymi piny a jen I2C1 ma konfigurovatelne piny.
 * */
// I2C0 (Inter-integrated Circuit Interface 0) [Driver_I2C0]
// Configuration settings for Driver_I2C0 in component ::Drivers:I2C
//
// jd: Set RTE_I2C0 to 1 to indicate that it is configured properly
